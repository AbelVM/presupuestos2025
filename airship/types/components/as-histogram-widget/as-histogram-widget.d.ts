...
import { AxisOptions, HistogramColorRange, HistogramData, TooltipFormat } from './interfaces';
/**
 * Histogram Widget
 *
 * @export
...
export declare class HistogramWidget {
    ...
    onNewData(newData: any, oldData: any): void;
     ...
     * @memberof HistogramWidget
     */
    getSelection(): Promise<Array<number | Date | string>>;
    /**
     ...
     * @memberof HistogramWidget
     */
    setSelection(values: number[] | null, emit?: boolean): Promise<void>;
    /**
