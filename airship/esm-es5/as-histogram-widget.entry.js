...
import { e as event, s as select, v as interpolate, w as customEvent, x as touch, y as mouse, l as linear, z as min, A as max, B as format } from './index-ba7acc67.js';
import { d as dispatch, i as interrupt } from './index-41aa841a.js';
...
var decimalFormatter = format('.3~f');
...
function precisionIsMicroOrSmaller(value) {
    ...
    var microTest = /\.0{3}|e-[4-9]|e-[0-9]{2,}/;
