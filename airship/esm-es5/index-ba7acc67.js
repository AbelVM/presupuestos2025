...
function transformer() {
    ...
    scale.domain = function (_) {
        return arguments.length ? (domain = map.call(_, number), clamp === identity$1 || (clamp = clamper(domain)), rescale()) : domain.slice();
    };
...
export { max as A, format as B, cubehelix as a, rgb as b, cubehelixLong as c, color as d, event as e, interpolateRgb as f, interpolateString as g, interpolateTransformSvg as h, interpolateNumber as i, selector as j, selectorAll as k, linear$1 as l, matcher$1 as m, namespace as n, selection as o, styleValue as p, interpolateTransformCss as q, rgbBasis as r, select as s, timeFormat as t, defaultLocale$1 as u, interpolate as v, customEvent as w, touch as x, mouse as y, min as z };
