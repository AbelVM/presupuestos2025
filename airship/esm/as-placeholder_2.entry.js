...
const PlaceholderBar = class {
    ...
    render() {
        ...
        return (h(Host, { style: styles }, h("div", { class: 'placeholder-bar' })));
    }
    static get style() { return "as-placeholder-bar{display:block;max-width:100%}.placeholder-bar{height:100%;background-color:var(--as--color--ui-02,#f5f5f5)}"; }
};
