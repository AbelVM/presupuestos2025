...
const interpolateSpectral = ramp(scheme$8);
...
const dataService = { getDomain, rawDataToStackBarData, getKeys, createLegendData };
...
const drawService = { drawColumns, drawYAxis };
