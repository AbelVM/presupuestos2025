...
const Infowindow = class {
    ...
    _renderStandarInfowindow(style = {}) {
        return (core.h("div", { class: 'as-infowindow', style: style }, this.src && core.h("img", { src: this.src }), core.h("div", { class: 'as-infowindow__content' }, core.h("slot", null)), core.h("div", { class: 'as-infowindow__hook' })));
    }
    _renderImageInfoWindow(style = {}) {
        return (core.h("div", { class: 'as-infowindow', style: style }, core.h("div", { class: 'as-infowindow__media' }, core.h("img", { src: this.src })), core.h("div", { class: 'as-infowindow__imageHook' }, core.h("div", { class: 'as-infowindow__imageHook--inner' }, core.h("img", { src: this.src, style: style })))));
    }
    _setupHook() {
